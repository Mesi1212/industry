...
from start.models import Student, Courses, Subject, CustomUser, Attendance, AttendanceReport, \
...
from .models import Student, AttendanceReport, Courses, Subject, Attendance, OnlineClassRoom, SessionYearModel
@login_required
def student_home(request):
    if request.user.is_authenticated:
        try:
            ...
            return render(request, "student_template/student_home_template.html", {"total_attendance": attendance_total, "attendance_absent": attendance_absent, "attendance_present": attendance_present, "subjects": Subject, "data_name": subject_name, "data1": data_present, "data2": data_absent, "class_room": class_room})
