...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self,request,view_func,view_args,view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type == "1":
                if modulename == "start.HodViews":
                    pass
                elif modulename == "start.views" or modulename == "django.views.static":
                    pass
                ...
                if modulename == "start.StaffViews" or modulename == "student_management_app.EditResultVIewClass":
                    pass
                elif modulename == "start.views" or modulename == "django.views.static":
                    pass
                else:
                ...
                if modulename == "start.StudentViews" or modulename == "django.views.static":
                    pass
                elif modulename == "start.views":
                    pass
                else:
